function Calendar(id, year, month) {     //calendar on the page02
...
document.querySelector('#calendar thead tr:nth-child(2) td:nth-child(1)').onclick = function() {
  Calendar("calendar", document.querySelector('#calendar thead td:nth-child(1)').dataset.year, parseFloat(document.querySelector('#calendar thead td:nth-child(1)').dataset.month)-1);
}
// переключатель плюс месяц
document.querySelector('#calendar thead tr:nth-child(2) td:nth-child(2)').onclick = function() {
  Calendar("calendar", document.querySelector('#calendar thead td:nth-child(1)').dataset.year, parseFloat(document.querySelector('#calendar thead td:nth-child(1)').dataset.month)+1);
}